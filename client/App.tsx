...
function ClaimsWorkspace({ cases, metrics, activeScenarioId, runScenario, loading }: { cases: ClaimsCase[]; metrics: AgentMetrics; activeScenarioId: string; runScenario: (id: string) => Promise<void>; loading: boolean }) {
