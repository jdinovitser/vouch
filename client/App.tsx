...
function WhyVouch({ navigate }: { navigate: (v: View) => void }) {
  return <div className="story-page why-page content-width">
    <StoryHero kicker="WHY VOUCH" title={<>People need help.<br /><em>Teams need more hands.</em></>} text="A food pantry has families waiting. A neighborhood group has requests piling up. A school or library has a small team trying to do more with limited time. AI can help—but can we trust an AI teammate with responsibility?" mascot="blocked" heroArtwork="warrior" cta="See trust being earned" onClick={() => navigate("demo")} />
